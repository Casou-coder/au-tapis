        ...
        <div className="max-w-4xl mx-auto">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-10">
            ...
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <p className="text-green-400 text-sm font-medium">Niveau 1</p>
                <h1 className="text-4xl font-bold text-white" style={{ fontFamily: 'var(--font-playfair)' }}>Débutant</h1>
              </div>
            </div>
            <p className="text-gray-400 mt-2">Maîtrisez les fondamentaux du Texas Hold&apos;em Poker.</p>
            ...
            {MODULES.map((mod, i) => {
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center justify-between">
                        <span className="text-xs text-green-400 font-medium">Module {i + 1}</span>
                  ...
                  {done && <p className="text-green-400 text-sm">✓ Terminé</p>}
                  {locked && <p className="text-gray-600 text-sm">🔒 Terminez le module précédent</p>}
                </motion.button>
              );
            })}
          </div>
          ...
          {completedModules.size === MODULES.length && (
            ...
            >
              ...
              <h3 className="text-xl font-bold text-white mb-2">Niveau Débutant complété !</h3>
              <p className="text-gray-400 mb-4">Vous maîtrisez les fondamentaux. Passez à l&apos;étape suivante.</p>
              <Link
                href="/intermediaire"
              ...
              >
                Niveau Intermédiaire <ChevronRight size={18} />
              </Link>
            </motion.div>
          )}
        </div>
  ...
  const steps = [
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-white/5 rounded-xl p-4">
              ...
              <h4 className="font-bold text-white mb-1">Vos cartes (hole cards)</h4>
              <p className="text-gray-400 text-sm">2 cartes face cachée, uniquement visibles par vous.</p>
            </div>
            <div className="bg-white/5 rounded-xl p-4">
              <div className="text-2xl mb-2">🎴</div>
              <h4 className="font-bold text-white mb-1">Les cartes communes (board)</h4>
              <p className="text-gray-400 text-sm">5 cartes partagées par tous les joueurs, révélées progressivement.</p>
            </div>
          </div>
        </div>
      ),
    },
    {
      ...
      content: (
        <div className="space-y-3">
          {[
            { phase: 'Pré-flop', desc: 'Distribution des 2 cartes privées. Premier tour d\'enchères.', cards: 0 },
            { phase: 'Flop', desc: '3 premières cartes communes révélées. Deuxième tour d\'enchères.', cards: 3 },
            { phase: 'Turn', desc: '4e carte commune révélée. Troisième tour d\'enchères.', cards: 4 },
            { phase: 'River', desc: '5e et dernière carte commune. Tour d\'enchères final.', cards: 5 },
            { phase: 'Showdown', desc: 'Révélation des cartes. Le meilleur combinaison gagne le pot.', cards: 5 },
          ].map((s, i) => (
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            <div className="p-4 rounded-xl bg-yellow-900/20 border border-yellow-600/30">
              ...
              <p className="text-gray-300 text-sm">Mise obligatoire du joueur à gauche du dealer. Généralement la moitié du big blind.</p>
            </div>
            <div className="p-4 rounded-xl bg-orange-900/20 border border-orange-600/30">
              ...
              <p className="text-gray-300 text-sm">Mise obligatoire du joueur à gauche du SB. C&apos;est la mise de base de la table (ex: 1€/2€ = SB 1€ / BB 2€).</p>
            </div>
            <div className="p-4 rounded-xl bg-blue-900/20 border border-blue-600/30">
              <h4 className="font-bold text-blue-400 mb-1">Le Dealer Button (BTN)</h4>
              <p className="text-gray-300 text-sm">Le bouton marque le dealer fictif. Il tourne à chaque main dans le sens des aiguilles d&apos;une montre.</p>
            </div>
          </div>
        </div>
      ),
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <p className="text-gray-300 leading-relaxed">
            Vous pouvez gagner de <strong className="text-white">deux façons</strong> :
          </p>
          <div className="grid grid-cols-2 gap-4">
            <div className="p-4 rounded-xl bg-green-900/20 border border-green-600/30 text-center">
              <div className="text-3xl mb-2">🃏</div>
              <h4 className="font-bold text-green-400 mb-1">Meilleure main</h4>
              <p className="text-gray-400 text-sm">Au showdown, avoir la meilleure combinaison de 5 cartes.</p>
            </div>
            <div className="p-4 rounded-xl bg-purple-900/20 border border-purple-600/30 text-center">
              <div className="text-3xl mb-2">🎭</div>
              <h4 className="font-bold text-purple-400 mb-1">Faire folder</h4>
              <p className="text-gray-400 text-sm">Miser de manière à forcer tous les adversaires à abandonner.</p>
            </div>
          </div>
          <div className="p-4 rounded-xl bg-white/5 border border-white/10">
            <p className="text-gray-300 text-sm">
              <strong className="text-yellow-400">Important :</strong> Vous n&apos;avez PAS besoin d&apos;avoir la meilleure main pour gagner. Le bluff est une stratégie valide et fondamentale du poker.
            </p>
          </div>
        </div>
      ),
...
function MainsModule({ onComplete, onBack }: { onComplete: () => void; onBack: () => void }) {
  ...
  return (
    <ModuleLayout title="Force des Mains" icon="🃏" color="#27ae60" onBack={onBack} step={0} totalSteps={1} onComplete={onComplete} onNext={onComplete} onPrev={onBack} isLastStep>
      ...
      <p className="text-gray-400 text-sm mb-6">Cliquez sur chaque main pour voir les détails. Du plus fort au plus faible.</p>
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="bg-black/30 rounded-lg p-3">
              <div className="text-gray-500 text-xs">Probabilité</div>
        ...
        {POSITIONS.map((p, i) => {
          ...
          return (
            ...
            >
              ...
              }`} style={{ color: selected === i ? '#fff' : colorMap[p.advantage] }}>
                {p.abbr}
              </div>
            </button>
          );
          ...
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              ...
              <span className="text-xs px-2 py-0.5 rounded-full" style={{ background: colorMap[pos.advantage] + '20', color: colorMap[pos.advantage] }}>
                Position {labelMap[pos.advantage]}
              </span>
            </div>
          </div>
          <p className="text-gray-300 text-sm mb-3">{pos.description}</p>
          <div className="bg-black/30 rounded-xl p-3">
            <div className="text-xs text-gray-500 mb-1">Stratégie recommandée</div>
    ...
    <ModuleLayout title="Les Actions" icon="⚡" color="#27ae60" onBack={onBack} step={step} totalSteps={actions.length} onComplete={onComplete} onNext={() => step < actions.length - 1 ? setStep(s => s + 1) : onComplete()} onPrev={() => step > 0 ? setStep(s => s - 1) : onBack()} isLastStep={step === actions.length - 1}>
      <AnimatePresence mode="wait">
        <motion.div key={step} initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -30 }} className="space-y-4">
          ...
          <div className="p-4 rounded-xl bg-white/5 border border-white/10">
            <div className="text-xs text-gray-500 mb-1">✅ Quand l&apos;utiliser</div>
            <p className="text-gray-300 text-sm">{a.when}</p>
          </div>

          <div className="p-4 rounded-xl bg-red-900/20 border border-red-800/30">
            <div className="text-xs text-gray-500 mb-1">⚠️ Erreur fréquente</div>
  ...
  return (
    <ModuleLayout title="Sélection de mains" icon="🎯" color="#27ae60" onBack={onBack} step={0} totalSteps={1} onComplete={onComplete} onNext={onComplete} onPrev={onBack} isLastStep>
        ...
        {[
          ...
          <div key={i} className={`p-4 rounded-xl border ${group.bg}`}>
            ...
            <div className="flex flex-wrap gap-1.5 mb-2">
              ...
              {i < 2 && <span className="text-gray-500 text-sm">et plus...</span>}
            </div>
      ...
      <div className="mt-4 p-4 rounded-xl bg-white/5 border border-white/10">
        <p className="text-yellow-400 text-sm font-medium mb-1">💡 Règle d&apos;or du débutant</p>
        <p className="text-gray-300 text-sm">
...
function QuizModule({ onComplete, onBack }: { onComplete: () => void; onBack: () => void }) {
  ...
  if (finished) {
    return (
      <ModuleLayout title="Quiz Final" icon="🏆" color="#27ae60" onBack={onBack} step={questions.length} totalSteps={questions.length} onComplete={onComplete} onNext={onComplete} onPrev={onBack} isLastStep>
  ...
  return (
    <ModuleLayout title="Quiz Final" icon="🏆" color="#27ae60" onBack={onBack} step={current} totalSteps={questions.length} onComplete={onComplete} onNext={next} onPrev={() => { setCurrent(c => c - 1); setSelected(null); }} isLastStep={current === questions.length - 1 && selected !== null}>
      <div className="mb-2 text-sm text-gray-500">Question {current + 1}/{questions.length}</div>
...
function TrainerModule({ onComplete, onBack }: { onComplete: () => void; onBack: () => void }) {
  return (
    <ModuleLayout title="Jouer des mains" icon="🎮" color="#27ae60" onBack={onBack} step={0} totalSteps={1} onComplete={onComplete} onNext={onComplete} onPrev={onBack} isLastStep>
      <h2 className="text-2xl font-bold text-white mb-2" style={{ fontFamily: 'var(--font-playfair)' }}>Mettez en pratique !</h2>
      <p className="text-gray-400 text-sm mb-5">
        Analysez ces situations réelles. Pour chaque main, choisissez la meilleure action et découvrez pourquoi.
      </p>
        ...
        <div className="max-w-2xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <div className="flex gap-3 mt-6">
              ...
              >
                {isLastStep ? '✓ Terminer le module' : 'Suivant'}
